...
if __name__ == "__main__":
    ...
    best_classifier_state = None  # 关键修改：重命名最佳状态变量
    ...
    for rnd in range(1, num_rounds + 1):
        ...
        global_classifier_state = average_state_dicts(classifier_states)  # 关键修改：聚合 classifier

        # 5. 同步参数
        for client in clients:
            client.set_encoder_state(global_encoder_state)
            client.set_classifier_state(global_classifier_state)  # 关键修改：同步 classifier
        ...
        if avg_f1 > best_f1:
            ...
            best_classifier_state = global_classifier_state  # 关键修改：保存 classifier 状态
